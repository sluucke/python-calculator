...
class Calculator:
    def __init__(self):
        ...
        self.window.call('wm', 'iconphoto', self.window._w, tk.PhotoImage(file='./icon.png'))
    ...
    def create_equals_button(self):
        button = tk.Button(self.buttons_frame, text='=', bg=LIGHT_PINK,
                           fg=OFF_WHITE, font=DEFAULT_FONT_STYLE, borderwidth=0, command=self.evaluate)
